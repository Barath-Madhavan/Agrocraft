...
const OurServices = () => {
    return (
        <Container className="main" fluid>
            ...
            Our farmer e-commerce platform offers a full range of services, including online order payments, to facilitate connections between consumers and farmers.On our e-commerce platform, you can find the freshest produce from nearby farmers and have it delivered right to your door!.
            Using our user-friendly e-commerce platform, you can purchase a variety of farm products from nearby farmers.
